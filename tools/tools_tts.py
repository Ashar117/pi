...
def _handle_speak(agent, tool_input, *, memory_override=None):
    return _tts.speak_async(text=tool_input["text"])
...
TOOLS = [
    ToolSpec(
        name="speak",
        description=(
            "Speak text aloud on Ash's computer using text-to-speech. Use for reading "
            "out important updates, reminders, or results. Non-blocking — Pi continues "
            "while speech plays."
        ),
        input_schema={
            "type": "object",

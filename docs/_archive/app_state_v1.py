# ARCHIVED (T-177, 2026-06-11): early-phase SQLite bootstrap (users table),
# superseded by tools/tools_memory.py MemoryTools._init_sqlite. Zero importers
# at archive time. Kept for reference, never imported.
import sqlite3
import json
